package app.template.moduleNotification

import android.annotation.TargetApi
import android.os.Build
import androidx.core.app.NotificationCompat
import app.template.moduleNotification.entities.Payload
import app.template.moduleNotification.internal.RawNotification
import app.template.moduleNotification.internal.utils.Action
import app.template.moduleNotification.internal.utils.Errors
import app.template.moduleNotification.internal.utils.Experimental
import app.template.moduleNotification.internal.utils.NotifyScopeMarker
...
class NotifyCreator internal constructor(private val notify: Notify) {
    ...
    @Deprecated(message = "Removed optional argument to alleviate confusion on ID that is used to create notification",
            replaceWith = ReplaceWith(
                    "Notify.show()",
                    "app.template.moduleNotification.Notify"))
    fun show(id: Int?): Int {
    ...
    @Deprecated(message = "Exposes function under the incorrect API -- NotifyCreator is reserved strictly for notification construction.",
            replaceWith = ReplaceWith(
                    ...
                    "android.content.Context", "app.template.moduleNotification.Notify"))
